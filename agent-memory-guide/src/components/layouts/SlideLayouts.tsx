        ...
        >
          {leftTexts.map((text: string, i: number) => (
            <motion.p 
              key={i} 
              variants={itemVariants}
              style={{ fontSize: '1.8rem', lineHeight: '1.7', color: 'var(--text-secondary)' }}
            ...
            {rightElements.map((el: any, i: number) => {
              ...
              return (
                <div key={i} style={{ display: 'flex', gap: '20px', alignItems: 'flex-start' }}>
                  ...
                  <div>
                    <h3 style={{ fontSize: '1.8rem', fontWeight: 700, marginBottom: '6px' }}>{el.title}</h3>
                    <p style={{ fontSize: '1.5rem', color: 'var(--text-secondary)' }} dangerouslySetInnerHTML={{ __html: el.description }} />
                  </div>
                </div>
              );
            })}
          ...
          return (
            ...
            >
              <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                ...
                <div>
                  <h3 style={{ fontSize: '1.8rem', fontWeight: 700, marginBottom: '10px' }}>{item.title}</h3>
                  <p 
                    style={{ fontSize: '1.5rem', color: 'var(--text-secondary)', lineHeight: '1.5' }}
    ...
    >
      ...
      >
        ...
        {(author || role) && (
          ...
          >
            {author && (
              <span style={{ fontSize: '2.0rem', fontWeight: 700, color: 'var(--text-primary)' }}>
                {author}
              </span>
            )}
            {role && (
              <span style={{ fontSize: '1.5rem', fontWeight: 500, color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: '0.1em' }}>
                {role}
              </span>
            )}
          </motion.div>
        ...
        >
          {steps.map((step: any, i: number) => (
            ...
            >
              ...
              <h3 style={{ fontSize: '1.6rem', fontWeight: 700, marginBottom: '8px' }}>
                {step.title}
              </h3>
              
              <p 
                style={{ fontSize: '1.4rem', color: 'var(--text-secondary)', maxWidth: '280px', lineHeight: '1.5' }}
      ...
      >
        {metrics.map((metric: any, i: number) => (
          ...
          >
            ...
            <h3 style={{ fontSize: '2.0rem', fontWeight: 700, color: 'var(--text-primary)' }}>
              {metric.label}
            </h3>
            <p style={{ fontSize: '1.5rem', color: 'var(--text-muted)', maxWidth: '380px', margin: '0 auto', lineHeight: '1.5' }}>
              {metric.description}
            </p>
          </motion.div>
        ))}
  ...
  return (
    <div className="slide-content">
      ...
      <div style={{
        ...
        >
          <motion.h3 variants={itemVariants} style={{ fontSize: '2.2rem', fontWeight: 700 }}>
            Interactive Demo Frame
          </motion.h3>
          <motion.p variants={itemVariants} style={{ fontSize: '1.6rem', color: 'var(--text-secondary)' }}>
